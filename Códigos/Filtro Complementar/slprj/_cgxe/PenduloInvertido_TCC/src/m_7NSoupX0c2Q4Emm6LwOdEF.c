...
#include "m_7NSoupX0c2Q4Emm6LwOdEF.h"
...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "C:\\Users\\mathe\\AppData\\Roaming\\MathWorks\\MATLAB Add-Ons\\Collections\\Rensselaer Arduino Support Package Library (RASPLib)\\hurstj0"
  "1-RASPLib-36dd13e\\RASPlib\\blocks\\soMPU6050Accel.m"/* pathName */
};

static emlrtRSInfo b_emlrtRSI = { 1,   /* lineNo */
  "System",                            /* fcnName */
  "C:\\Program Files\\Polyspace\\R2020a\\toolbox\\shared\\system\\coder\\+matlab\\+system\\+coder\\System.p"/* pathName */
};

static emlrtRSInfo c_emlrtRSI = { 1,   /* lineNo */
  "SystemProp",                        /* fcnName */
  "C:\\Program Files\\Polyspace\\R2020a\\toolbox\\shared\\system\\coder\\+matlab\\+system\\+coder\\SystemProp.p"/* pathName */
};

static emlrtRSInfo d_emlrtRSI = { 1,   /* lineNo */
  "SystemCore",                        /* fcnName */
  "C:\\Program Files\\Polyspace\\R2020a\\toolbox\\shared\\system\\coder\\+matlab\\+system\\+coder\\SystemCore.p"/* pathName */
};
...
static emlrtRSInfo j_emlrtRSI = { 1,   /* lineNo */
  ...
  "C:\\Program Files\\Polyspace\\R2020a\\toolbox\\coder\\coder\\+coder\\+internal\\matlabCodegenHandle.p"/* pathName */
};

static emlrtMCInfo emlrtMCI = { 1,     /* lineNo */
  1,                                   /* colNo */
  "SystemCore",                        /* fName */
  "C:\\Program Files\\Polyspace\\R2020a\\toolbox\\shared\\system\\coder\\+matlab\\+system\\+coder\\SystemCore.p"/* pName */
};

/* Function Declarations */
static void cgxe_mdl_start(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance, const emlrtStack *sp);
static soMPU6050Accel *soMPU6050Accel_soMPU6050Accel
  (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance, soMPU6050Accel *obj);
static void SystemCore_setup(const emlrtStack *sp, soMPU6050Accel *obj);
static void mw__internal__call__reset(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance, const emlrtStack *sp, int16_T *c_y0, int16_T *c_y1, int16_T
  *b_y2);
static const mxArray *emlrt_marshallOut(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF
  *moduleInstance);
  ...
  (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance)
{
  ...
  covrtScriptInit(moduleInstance->covInst_CONTAINER_BLOCK_INDEX,
                  "C:\\Users\\mathe\\AppData\\Roaming\\MathWorks\\MATLAB Add-Ons\\Collections\\Rensselaer Arduino Support Package Library (RASPLib)\\hurstj0"
                  "1-RASPLib-36dd13e\\RASPlib\\blocks\\soMPU6050Accel.m", 0U, 5U,
                  8U, 3U, 0U, 0U, 0U, 0U, 0U, 0U, 0U);
...
/* CGXE Glue Code */
static void mdlOutputs_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S, int_T tid)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S, int_T tid)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
  InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *moduleInstance =
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF *)calloc(1, sizeof
    (InstanceStruct_7NSoupX0c2Q4Emm6LwOdEF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_7NSoupX0c2Q4Emm6LwOdEF);
  ssSetmdlInitializeConditions(S, mdlInitialize_7NSoupX0c2Q4Emm6LwOdEF);
  ssSetmdlUpdate(S, mdlUpdate_7NSoupX0c2Q4Emm6LwOdEF);
  ssSetmdlTerminate(S, mdlTerminate_7NSoupX0c2Q4Emm6LwOdEF);
  ssSetmdlEnable(S, mdlEnable_7NSoupX0c2Q4Emm6LwOdEF);
  ssSetmdlDisable(S, mdlDisable_7NSoupX0c2Q4Emm6LwOdEF);
...
static void mdlProcessParameters_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S)
{
}

void method_dispatcher_7NSoupX0c2Q4Emm6LwOdEF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_7NSoupX0c2Q4Emm6LwOdEF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_7NSoupX0c2Q4Emm6LwOdEF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_7NSoupX0c2Q4Emm6LwOdEF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_7NSoupX0c2Q4Emm6LwOdEF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 7NSoupX0c2Q4Emm6LwOdEF.\n"
...
mxArray *cgxe_7NSoupX0c2Q4Emm6LwOdEF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_7NSoupX0c2Q4Emm6LwOdEF_fallback_info(void)
{
